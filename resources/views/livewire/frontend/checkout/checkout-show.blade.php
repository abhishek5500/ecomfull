...
<div class="py-3 py-md-4 checkout">
        <div class="container">
                        ...
                        <form action="" method="POST">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="string" id="phone" wire:model.defer="phone" class="form-control" placeholder="Enter Phone Number" />
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            ...
                                            <div class="tab-pane fade" id="onlinePayment" role="tabpanel" aria-labelledby="onlinePayment-tab" tabindex="0">
                                                ...
                                                <div wire:ignore style="width:40%">
            ...
            <div class="card card-body shadow text-center">
                ...
                <a href="{{url('/collections')}}" class="btn btn-warning w-100">Shop Now</a>
            </div>
            @endif
        </div>
    </div>
...
@push('scripts')
<script src="https://www.paypal.com/sdk/js?client-id=AWLc51wsH6lXbhaKCHY8I5zpX0hANqIQeS9h8KNC2r6ko3NLL64r5VrGGMn8BkEuW60_ZYDmx9nd0guP&currency=USD"></script>
<script>
    paypal.Buttons({
